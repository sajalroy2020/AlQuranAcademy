                ...
                ->addColumn('action', function ($data){
                    return '<div class="dropdown dropdown-one">
                                ...
                                <ul class="dropdown-menu dropdownItem-one">
                                    <li>
                                        <button onclick="editCommonModal(\'' . route('student.edit', $data->id) . '\'' . ', \'#editModal\')" class="border-0 bg-transparent p-0 d-flex align-items-center cg-8" data-bs-toggle="modal">
                                            <div class="d-flex">
                                    ...
                                    <li>
                                        <button onclick="deleteCommonMethod(\'' . route('student.delete', $data->id) . '\', \'studentDataTable\')" class="border-0 bg-transparent p-0 d-flex align-items-center cg-8">
                                            <div class="d-flex">
