...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link {{@$activeDashboard}}" href="{{route('dashboard')}}">
        ...
        @if(auth()->user()->role == USER_ROLE_ADMIN)
          <li class="nav-item">
            <a class="nav-link {{@$activeScheduleCheck}}" href="{{route('admin.class-schedule.check')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <span class="nav-link-text ms-1">Class schedules check</span>
            </a>
          </li>

          <li class="nav-item">
            <a href="#" class="d-flex align-items-center nav-link" data-bs-toggle="collapse" data-bs-target="#collapseExample3" aria-expanded="false" aria-controls="collapseExample">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>box-3d-50</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <li class="nav-item">
            <a class="nav-link {{@$activeCourse}}" href="{{route('admin.course.all')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>box-3d-50</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <li class="nav-item">
            <a href="#" class="d-flex align-items-center nav-link {{@$activeMenu}}" data-bs-toggle="collapse" data-bs-target="#collapseExample2" aria-expanded="false" aria-controls="collapseExample">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>box-3d-50</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="nav-link-text ms-1">Country Setting</span>
            </a>
        ...
        @elseif(auth()->user()->role == USER_ROLE_TEACHER)
          <li class="nav-item">
            <a href="#" class="d-flex align-items-center nav-link {{@$activeMenu}}" data-bs-toggle="collapse" data-bs-target="#collapseExample2" aria-expanded="false" aria-controls="collapseExample">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <span class="nav-link-text ms-1">Class Schedule</span>
            </a>
            <div class="collapse" id="collapseExample2" data-bs-parent="#sidebarMenu">
                <ul class="ms-4">
                  <li><a class="text-xs {{@$activeCountry}}" href="{{route('admin.country.all')}}">{{__('Today Schedule')}}</a></li>
                  <li><a class="text-xs {{@$activeState}}" href="{{route('admin.state.all')}}">{{__('All Schedule')}}</a></li>
                </ul>
            </div>
          </li>
        @elseif(auth()->user()->role == USER_ROLE_STUDENT)
          <li class="nav-item">
            ...
            <div class="collapse" id="collapseExample2" data-bs-parent="#sidebarMenu">
                <ul class="ms-4">
                    <li><a class="text-xs {{@$activeCountry}}" href="{{route('admin.country.all')}}">{{__('Today Class')}}</a></li>
                    <li><a class="text-xs {{@$activeState}}" href="{{route('admin.state.all')}}">{{__('All Class List')}}</a></li>
                </ul>
            </div>
          </li>
        @endif
