    ...
    <div class="p-30">
        ...
        <div class="bg-white rounded p-3">
            ...
            <div class="table-responsive zTable-responsive">
                <table class="table zTable" id="stateDataTable">
                    <thead>
                        <tr>
                            <th scope="col"><div>{{ __('Country Name') }}</div></th>
                            <th scope="col"><div>{{ __('State Name') }}</div></th>
...
<input type="hidden" id="state-list-route" value="{{ route('admin.state.all') }}">
@endsection
